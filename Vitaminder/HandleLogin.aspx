...
<body>
    <form id="frmMain" runat="server">
        ...
        <div class="container">
            ...
            <div class="alert alert-info" role="alert">Code: <asp:Literal ID="litCode" runat="server"></asp:Literal></div>

            <div class="well"><asp:Literal ID="litResult" runat="server"></asp:Literal></div>
